    ...
    <defs>
      ...
      <g id="ball">
        ...
        <g id="plane">
          ...
          <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family='Tektur' font-size="31" fill="#0170BB">Το μαγαζί σου στο Διαδίκτυο </text>
...
.border-animation:after {
  content: "";
  background: linear-gradient(45deg, #ccc 48.9%, #0B409C 49%);
